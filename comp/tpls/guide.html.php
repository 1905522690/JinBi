...
<div class="fr w725">
     <div class="pageNow"><a href="">首页</a> > <a href="">规章制度</a> > <span>入会指南</span></div>
     <!--内容-->
     
     <?php Template::$_tplval['info'] = TagAttrLoop::emsdeital('cn_guizh','id',''.urldecode($_GET["id"]).'','','__typeid=236','','','','',''); ?>
     <div class="guide">
