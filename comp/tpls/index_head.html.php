<?php if(!defined('WEB_ROOT')) exit();?><div class="wal">
    ...
    <div class="nav">
      <ul>
        ...
        <li><a href="<?php echo WEB_APP; ?>notice.html" <?php if($_GET['PARENT_TPL_FILE']=="notice.html" || $_GET['PARENT_TPL_FILE']=="news.html" || $_GET['PARENT_TPL_FILE']=="news3.html" || $_GET['PARENT_TPL_FILE']=="news4.html" || $_GET['PARENT_TPL_FILE']=="newShow.html" || $_GET['PARENT_TPL_FILE']=="noticeShow.html" || $_GET['PARENT_TPL_FILE']=="news3Show.html" || $_GET['PARENT_TPL_FILE']=="news4Show.html"){ ?>  class="aNow" <?php } ?> 
        >行业动态</a></li>
        ...
        <li><a href="">会员服务</a></li>
        <li><a href="<?php echo WEB_APP; ?>knowledge.html" <?php if($_GET['PARENT_TPL_FILE']=="knowledge.html" || $_GET['PARENT_TPL_FILE']=="project.html" || $_GET['PARENT_TPL_FILE']=="classroom.html" || $_GET['PARENT_TPL_FILE']=="research.html"){ ?>  class="aNow" <?php } ?> 
        >培训学院</a></li>
        <li><a href="">联系我们</a></li>
      </ul>
    </div>
